...
sub encapsulate {
   my $types = {
      NETPKT_IPv4_PROTOCOL_TCP()    => Net::Pkt::Frame::NETPKT_LAYER_TCP(),
      NETPKT_IPv4_PROTOCOL_UDP()    => Net::Pkt::Frame::NETPKT_LAYER_UDP(),
      NETPKT_IPv4_PROTOCOL_ICMPv4() => Net::Pkt::Frame::NETPKT_LAYER_ICMPv4(),
   };
